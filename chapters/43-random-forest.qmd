...
[Vandeputte et al. (2017)](https://doi.org/10.1038/nature24460)展示了 microbial load 如何改变疾病关联；[Topçuoğlu et al. (2020)](https://doi.org/10.1128/mBio.00434-20)系统指出 microbiome machine learning 对 preprocessing、validation 和 leakage 极其敏感。以下分析在公开 Vandeputte cohort 上完全使用 out-of-fold 预测，并同时检查 ROC、calibration、permutation/importance 和 microbial-load regression。
