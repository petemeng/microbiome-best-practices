...
reader-reproduction:
  ...
  script: examples/43-random-forest.R
  packages:
  - ggplot2
  - pROC
  - patchwork
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/43-random-forest.R)。脚本包含数据下载、计算和图形导出。
...
### 用相同规则 nested-CV 回归 microbial load
...
## 从ROC继续检查校准、置换与稳定性 {#sec-beautify}
...
## 报告嵌套交叉验证与预测性能的方法与限制 {#sec-methods}
...
## 将嵌套交叉验证与预测性能用于自己的研究 {#sec-own-data}
