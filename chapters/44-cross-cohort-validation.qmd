...
reader-reproduction:
  ...
  script: examples/44-cross-cohort-validation.R
  packages:
  - ggplot2
  - ggrepel
  - metafor
...
[Duvallet et al. (2017)](https://doi.org/10.1038/s41467-017-01973-8)用统一处理的公开研究区分 disease-specific 与跨疾病 microbial signatures；[Wirbel et al. (2019)](https://doi.org/10.1038/s41591-019-0406-6)展示 CRC shotgun cohorts 的跨研究 meta-analysis 与 external classification。
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/44-cross-cohort-validation.R)。脚本包含数据下载、计算和图形导出。
...
### leave-one-study-out external classification
...
## 同时报告平均效应、异质性与外部表现 {#sec-beautify}
...
## 报告跨队列合并与外部验证的方法与限制 {#sec-methods}
...
## 将跨队列合并与外部验证用于自己的研究 {#sec-own-data}
