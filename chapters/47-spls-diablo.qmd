...
[Singh et al. (2019)](https://doi.org/10.1093/bioinformatics/bty1054)用 DIABLO 展示 supervised multi-omics integration、sample plots、circos/loadings 与 prediction performance。以下分析使用 [Franzosa et al. (2019)](https://doi.org/10.1038/s41564-018-0306-4) 的公开 IBD 配对数据，同时检查 cross-block generalization、DIABLO scores、locked-test confusion/AUC 与 feature stability。
...
## 共同变化、监督分离与预测验证是三个任务 {#sec-theory}
