...
reader-reproduction:
  ...
  script: examples/47-spls-diablo.R
  packages:
  - ggplot2
  - jsonlite
  - mixOmics
...
[Singh et al. (2019)](https://doi.org/10.1093/bioinformatics/bty1054)用 DIABLO 展示 supervised multi-omics integration、sample plots、circos/loadings 与 prediction performance。以下分析使用 [Franzosa et al. (2019)](https://doi.org/10.1038/s41564-018-0306-4) 的公开 IBD 配对数据，同时检查 cross-block generalization、DIABLO scores、锁定测试集 confusion/AUC 与 feature stability。
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/47-spls-diablo.R)。脚本包含数据下载、计算和图形导出。
...
完整计算脚本：[run_article47_diablo.R](https://github.com/petemeng/microbiome-best-practices/blob/3cb6a817e0c73ab7ecbec1cedc1ad80cbb9ecfaa/scripts/run_article47_diablo.R)。
...
### DIABLO：training-only tuning、repeated CV、一次 test prediction
...
## 报告sPLS与DIABLO验证的方法与限制 {#sec-methods}
...
## 将sPLS与DIABLO验证用于自己的研究 {#sec-own-data}
