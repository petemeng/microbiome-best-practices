...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/22-ordination-unconstrained.R)。脚本包含数据下载、计算和图形导出。
...
## 从距离矩阵得到PCoA、NMDS与CLR-PCA {#sec-code}
...
## 报告距离、排序和离散度检验的方法与限制 {#sec-methods}
...
## 将距离、排序和离散度检验用于自己的研究 {#sec-own-data}
