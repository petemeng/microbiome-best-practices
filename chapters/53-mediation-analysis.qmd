...
reader-reproduction:
  ...
  script: examples/53-mediation-analysis.R
  packages:
  - ggplot2
  - mediation
  - patchwork
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/53-mediation-analysis.R)。脚本包含数据下载、计算和图形导出。
...
## 把间接效应与因果假设一起呈现 {#sec-publication}
...
## 报告中介效应与敏感性分析的方法与限制 {#sec-methods}
...
## 将中介效应与敏感性分析用于自己的研究 {#sec-own-data}
