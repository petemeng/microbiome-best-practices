...
reader-reproduction:
  ...
  script: examples/42-functional-guilds.R
  packages:
  - ggplot2
  - ggrepel
  - microeco
...
[Louca et al. (2016)](https://doi.org/10.1126/science.aaf4507)用 taxonomy–function literature mapping 描述全球海洋微生物功能；[Wemheuer et al. (2020)](https://doi.org/10.1186/s40168-020-00815-y)则以 Tax4Fun2 引入 reference-data-based functional prediction 与 functional redundancy index。
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/42-functional-guilds.R)。脚本包含数据下载、计算和图形导出。
...
### 计算 assignment composition 与多重检验
...
## 将功能类群数据库映射用于自己的研究 {#sec-own-data}
