...
reader-reproduction:
  ...
  script: examples/54-mendelian-randomization.R
  packages:
  - MRPRESSO
  - TwoSampleMR
  - ggplot2
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/54-mendelian-randomization.R)。脚本包含数据下载、计算和图形导出。
...
## 比较主估计与方向性、稳健性分析 {#sec-publication}
...
## 报告遗传工具与MR敏感性分析的方法与限制 {#sec-methods}
...
## 将遗传工具与MR敏感性分析用于自己的研究 {#sec-own-data}
