...
reader-reproduction:
  ...
  script: examples/21-beta-distances.R
  packages:
  - ape
  - digest
  - dplyr
...
```bash
conda env create --prefix ./gemelli-env --file env/gemelli.yml
```
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/21-beta-distances.R)。脚本包含数据下载、计算和图形导出。
...
### 用维护中的 gemelli 计算 Robust Aitchison
...
## 将距离定义与零值处理用于自己的研究 {#sec-own-data}
