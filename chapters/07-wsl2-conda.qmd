...
::: {.callout-important title="把 Windows 管理与 Linux 分析分开"}
...
## WSL2、conda 与 mamba 各自解决什么问题 {#sec-theory}
...
## 检查系统、环境与真实数据是否就绪 {#sec-publication}
...
## 将Linux与软件环境用于自己的研究 {#sec-own-data}
