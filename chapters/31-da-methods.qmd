...
[Nearing et al. (2022)](https://doi.org/10.1038/s41467-022-28034-z)在 38 个 16S 数据集上比较 14 种差异丰度（differential abundance, DA）方法。其 Figure 1 展示了同一数据集换方法后，显著 feature 的比例可以大幅变化；Figure 3 进一步比较方法间重叠。下面用一套真实湿地数据做“同设计横评”：所有方法只允许改变统计模型，不允许改变数据或 contrast。
