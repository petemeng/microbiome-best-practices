...
reader-reproduction:
  ...
  script: examples/36-network-robustness.R
  packages:
  - SpiecEasi
  - ggplot2
  - ggrepel
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/36-network-robustness.R)。脚本包含数据下载、计算和图形导出。
...
### Density-matched 组间网络、置换和 bootstrap
...
## 检查拓扑结论是否依赖密度和删除策略 {#sec-publication}
