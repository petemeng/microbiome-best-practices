...
reader-reproduction:
  ...
  script: examples/32-multirank-da.R
  packages:
  - ALDEx2
  - ggplot2
  - ggrepel
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/32-multirank-da.R)。脚本包含数据下载、计算和图形导出。
