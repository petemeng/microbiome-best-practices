---
title: "第 16 篇 · 系统发育树（SEPP fragment insertion）"
...
Janssen 等人的 SEPP 评估中，Figure 5 用已知来源的 V4 片段量化插入误差与歧义，Figure S2 比较 alignment/placement subset 的运行代价，Figure 12 对比 reference insertion 与 de novo tree construction。本页不复制论文原图，而是把同样的验证逻辑落实到真实 ASV。
