...
reader-reproduction:
  ...
  script: examples/18-publication-graphics.R
  packages:
  - colorspace
  - ggplot2
  - jsonlite
...
[下载完整 R 脚本](https://github.com/petemeng/microbiome-best-practices/blob/691722146e287afe063bd43e9ce4fa41977fe763/examples/18-publication-graphics.R)。脚本包含数据下载、计算和图形导出。
...
完整计算脚本：[validate_publication_graphics.R](https://github.com/petemeng/microbiome-best-practices/blob/3cb6a817e0c73ab7ecbec1cedc1ad80cbb9ecfaa/scripts/validate_publication_graphics.R)。
...
## 检查屏幕预览与投稿文件的差别 {#sec-publication}
...
## 报告图形尺寸、字体与导出格式的方法与限制 {#sec-methods}
...
## 将图形尺寸、字体与导出格式用于自己的研究 {#sec-own-data}
